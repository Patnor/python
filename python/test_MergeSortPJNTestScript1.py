...
array1 = []
sorted_array1 = pf.merge_sort(array1, True)
...
array2 = [5]
sorted_array2 = pf.merge_sort(array2, True)
...
array3 = [9, 2]
sorted_array3 = pf.merge_sort(array3, True)
...
sorted_array4 = pf.merge_sort(array4, True)
...
array5 = [-5, -2, -9, -1, -3]
sorted_array5 = pf.merge_sort(array5, True)
...
array6 = [1, 2, 3, 4, 5]
sorted_array6 = pf.merge_sort(array6, True)
...
array7 = [5, 4, 3, 2, 1]
sorted_array7 = pf.merge_sort(array7, True)
...
sorted_array8 = pf.merge_sort(array8)
end_time2 = time.time()
...
sorted_array9 = pf.merge_sort(array9)
end_time3 = time.time()
...
sorted_array10 = pf.merge_sort(array10)
end_time1 = time.time()
